...
SECRET_KEY = 'django-insecure-n8c7!jg(8j4a0z_bl^%7b_^^j&#0-fpg!s3d$#=8l^cogcse1l'
...
# Section C - Question 2: Relational Database Integration (MySQL/PostgreSQL config ready to use).
# DATABASES = {
#     'default': {
